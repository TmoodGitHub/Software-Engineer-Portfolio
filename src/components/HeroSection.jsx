      ...
      <div className="container max-w-4xl mx-auto text-center z-10">
        <div className="space-y-6">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-2-2xl mx-auto opacity-0 animate-fade-in-delay-3">
            I build scalable, efficient web applications that solve real
            problems. Specializing in full-stack development, I bring together
            clean architecture, thoughtful UX, and modern cloud infrastructure.
          </p>
